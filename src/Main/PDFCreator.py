...
class DocxCreator ():
    ...
    template_file_path = working_directory+'/src/Resources/OutputCourierForm/CourierForm.docx'
    output_file_path = working_directory+'/src/Resources/OutputCourierForm/DocxForm/result.docx'
    # read information from file txt
    def read_file(self):
        # print working directory
        print(os.getcwd())
        
        with open(working_directory+'/src/Resources/OutputCourierForm/prototype/CurrentCourierInfo.txt', 'r') as file:
